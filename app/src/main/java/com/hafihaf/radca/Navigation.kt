...
import com.hafihaf.radca.ui.add_edit_todo.AddEditTodoScreen
import com.hafihaf.radca.ui.todo_list.TodoListScreen
import com.hafihaf.radca.util.Routes

@Composable
fun Navigation() {
    val navController = rememberNavController()
    NavHost(navController = navController, startDestination = Routes.TODO/*DRUZINOVKA*/) {
